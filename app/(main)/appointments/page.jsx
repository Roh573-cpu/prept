...
export default async function MyAppointmentsPage() {
  ...
  // A booking is active/upcoming if it is marked SCHEDULED and hasn't ended yet
  const scheduled = appointments.filter(
    (a) => a.status === "SCHEDULED" && new Date(a.endTime) > now,
  );

  // A booking moves to past if it's explicitly completed/cancelled, OR if its time block is completely over
